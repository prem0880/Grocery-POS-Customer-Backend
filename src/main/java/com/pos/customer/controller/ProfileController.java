...
public class ProfileController {
    ...
    public ResponseEntity<String> addState(@PathVariable("countryCode") Long countryCode,@RequestBody State stateDetails) 
    {
    ...
    public ResponseEntity<String> updateCustomer(@PathVariable("phoneNo") Long phoneNo,@RequestBody Customer customerDetails)
    {
    	return customerService.updateCustomer(phoneNo,customerDetails);
    }
    @PostMapping("/customer/{customerId}/state/{stateId}/addAddress")
    public ResponseEntity<String> addAddress(@PathVariable("customerId") Long customerId,@PathVariable("stateId") Long stateId,@RequestBody Address addressDetails)
    {
